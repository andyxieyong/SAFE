...
public class CompareTest extends TestCase {
	...
	public int compare(FitnessList list1, FitnessList list2){
		SolutionListComparator2<TimeListSolution> comparator = new SolutionListComparator2<TimeListSolution>(0);
		
		boolean diff = comparator.UtestSignificance(list1, list2);
		System.out.println("diff=" + diff);
		if (diff == true) {
			int result = 0;
			double value = 0.0;
			value = comparator.A12(list1, list2);
