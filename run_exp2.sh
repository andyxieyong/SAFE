...
java -Xms4G -Xmx10G -jar artifacts/P1-StressTesting.jar -r 1 --runID 1 -b results/EXP2_GASearch

# Feature reduction and treating imbalanced data
# 02_features.R <BASE_PATH of P1> <Output path of this script> <Number of runs>
Rscript R/02_features.R results/EXP2_GASearch analysis/02_features 1
# 03_prune_input.R <BASE_PATH of P1> <Output path of this script> <Number of runs>
Rscript R/03_prune_input.R results/EXP2_GASearch analysis/03_prune 1
...
java -Xms4G -Xmx10G -jar artifacts/P2-Refinements.jar -w Updates100 -b results/EXP2_GASearch --runID 1 --secondRuntype distance
